...
class StartupsControllerTest < ActionController::TestCase
  ...
  test "should create startup" do
    assert_difference('Startup.count') do
      post :create, startup: { about: @startup.about, entrepreneur_id: @startup.entrepreneur_id, founderinfo: @startup.founderinfo, link: @startup.link, name: @startup.name }
    end
  ...
  test "should update startup" do
    patch :update, id: @startup, startup: { about: @startup.about, entrepreneur_id: @startup.entrepreneur_id, founderinfo: @startup.founderinfo, link: @startup.link, name: @startup.name }
    assert_redirected_to startup_path(assigns(:startup))
  end
